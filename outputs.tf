...
output "this_snat_entry_id_of_computed_snat_with_source_cidrs" {
  ...
  value       = concat(alicloud_snat_entry.computed_snat_with_source_cidrs.*.snat_entry_id, [""])[0]
}
...
output "this_snat_entry_name_of_computed_snat_with_source_cidrs" {
  ...
  value       = concat(alicloud_snat_entry.computed_snat_with_source_cidrs.*.snat_entry_name, [""])[0]
}
...
output "this_snat_entry_id_of_computed_snat_with_vswitch_ids" {
  ...
  value       = concat(alicloud_snat_entry.computed_snat_with_vswitch_ids.*.snat_entry_id, [""])[0]
}
...
output "this_snat_entry_name_of_computed_snat_with_vswitch_ids" {
  ...
  value       = concat(alicloud_snat_entry.computed_snat_with_vswitch_ids.*.snat_entry_name, [""])[0]
}